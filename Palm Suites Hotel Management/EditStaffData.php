...
<head>
    <title>
    <?php
        echo "Edit Staff Data";
    ?>
    </title>
    <script type ="text/javascript" src = "StaffForm.js"></script>
    <style>
     body {
  background-image: url('editstaff.jpg');
...
<ul>
         ...
         <li><a class="active" href="EditStaffData.php">Edit Staff Data</a></li>
...
<form id="form1" action ="EditStaffData.php" onsubmit="return validateform();" method="POST">
<table width="55%" border="0">
    <tr>
        <td> Staff ID Before Update ( ST[0-9][0-9][0-9] ) </td>
        <td><input type="text" name="StaffID1"></td>
    </tr>
    <tr>
        <td> Staff ID After Update ( ST[0-9][0-9][0-9] ) </td>
        <td><input type="text" name="StaffID2"></td>
    </tr>
    <tr>
        <td> Staff Name </td>
    ...
    <tr>
        <td>
            <button type="submit">Edit Staff Data</button> 
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query1 = "update Staff set StaffID='$StaffID2',StaffName='$StaffName',StaffSalary='$StaffSalary',StaffAddress='$StaffAddress',StaffPhone='$StaffPhone',StaffEmail='$StaffEmail',StaffGender='$StaffGender',StaffAge='$StaffAge',JobID='$JobID' where StaffID='$StaffID1' ";
